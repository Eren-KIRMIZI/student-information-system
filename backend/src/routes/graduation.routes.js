...
router.get('/transcript/student/:studentId', authenticate, authorize('ADMIN', 'ACADEMICIAN'), ctrl.getTranscriptForStudent);
router.get('/graduation/my', authenticate, authorize('STUDENT'), ctrl.getMyGraduationStatus);
router.get('/graduation/student/:studentId', authenticate, authorize('ADMIN', 'ACADEMICIAN'), ctrl.checkStudentGraduation);
