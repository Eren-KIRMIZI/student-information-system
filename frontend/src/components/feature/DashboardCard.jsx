...
export const DashboardListItem = ({
  ...
  <div
    ...
    onClick={onClick}
    onMouseEnter={(e) => {
      if (onClick) e.currentTarget.style.background = 'var(--color-surface-3)';
    }}
    onMouseLeave={(e) => {
      if (onClick) e.currentTarget.style.background = 'var(--color-surface-2)';
    }}
  >
    ...
    <div style={{ flexShrink: 0, marginLeft: 8 }}>{badgeStatus ? <StatusBadge status={badgeStatus} /> : badge}</div>
  </div>
);
