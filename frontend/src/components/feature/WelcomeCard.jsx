...
export const WelcomeCard = ({ user, roleLabel, messages = [], isLoading }) => {
  if (isLoading) {
    return (
      <div className="card" style={{ marginBottom: 24, background: 'linear-gradient(to right, var(--color-primary-600), var(--color-primary-800))', color: 'white' }}>
    ...
    <div className="card" style={{ 
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <p style={{ fontSize: 14, opacity: 0.8, marginBottom: 16 }}>
          {roleLabel} Paneline Hoş Geldiniz
        </p>
