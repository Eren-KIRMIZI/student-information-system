        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              <div style={{ fontSize: 13, fontWeight: 900, color: 'var(--color-primary-600)', letterSpacing: '0.02em', lineHeight: 1.1 }}>EREN TEKNİK</div>
              <div style={{ fontSize: 10, color: 'var(--color-text-muted)', fontWeight: 700, letterSpacing: '0.05em' }}>ÜNİVERSİTESİ</div>
            </div>
          </div>
          <button
            onClick={onClose}
