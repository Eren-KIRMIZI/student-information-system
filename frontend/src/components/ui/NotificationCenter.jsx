...
const NotificationCenter = () => {
  ...
  useEffect(() => {
    ...
    setNotifications([
      { id: 1, title: 'Notunuz Açıklandı', message: 'Bilgisayar Ağları dersi notunuz sisteme girildi.', type: 'info', read: false, createdAt: new Date(Date.now() - 1000 * 60 * 5).toISOString() },
      { id: 2, title: 'Danışman Onayı', message: 'Ders seçimleriniz danışmanınız tarafından onaylandı.', type: 'success', read: false, createdAt: new Date(Date.now() - 1000 * 60 * 60).toISOString() },
      { id: 3, title: 'Devamsızlık Uyarısı', message: 'Veritabanı Yönetim Sistemleri dersi devamsızlık sınırına yaklaştınız.', type: 'warning', read: true, createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString() },
    ]);
    setUnreadCount(2);
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 }}>
                      ...
                      <span style={{ fontSize: 11, color: 'var(--color-text-muted)', display: 'flex', alignItems: 'center', gap: 4, flexShrink: 0 }}>
                        <Clock size={10} />
