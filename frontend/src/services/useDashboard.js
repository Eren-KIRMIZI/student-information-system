...
export const useDashboardStudent = () => useQuery({ queryKey: ['dashboard', 'student'], queryFn: getDashboardStudent });

export const useDashboardAcademician = () =>
  useQuery({ queryKey: ['dashboard', 'academician'], queryFn: getDashboardAcademician });

export const useDashboardAdmin = () => useQuery({ queryKey: ['dashboard', 'admin'], queryFn: getDashboardAdmin });
