...
const ForgotPassword = () => {
    ...
    return (
      <div style={{ textAlign: 'center', padding: '16px 0', animation: 'scaleIn 0.25s ease' }}>
        ...
        <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.6, marginBottom: 24 }}>
          ...
          Geliştirme ortamında link sunucu konsolunda görünür.
        </p>
  ...
  return (
    <div className="animate-fade-in">
      <Link to="/login" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 13, color: '#64748b', textDecoration: 'none', marginBottom: 20 }}>
