                    ...
                    <tr key={s.id}>
                      ...
                      <td>
                        <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
                          ...
                          <button
                            className="btn btn-ghost btn-sm"
                            onClick={() => statusMutation.mutate({ id: s.id, isActive: !s.user?.isActive })}
                            title={s.user?.isActive ? 'Pasifleştir' : 'Aktifleştir'}
                            style={{ color: s.user?.isActive ? 'var(--color-warning)' : 'var(--color-success)' }}
                          >
                            {s.user?.isActive ? <ToggleRight size={16} /> : <ToggleLeft size={16} />}
                          </button>
                        </div>
                      </td>
                    </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="input-wrapper">
              ...
              <input {...register('nationalId')} className="input" placeholder="12345678901" />
            </div>
          </div>
