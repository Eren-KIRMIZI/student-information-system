...
import { ArrowLeft, Mail, Phone, GraduationCap, BookOpen, ToggleLeft, ToggleRight, Award } from 'lucide-react';
                ...
                <tbody>
                  {lecturer.sections.map((sec) => (
                    <tr key={sec.id}>
                      ...
                      <td>
                        <span className="badge badge-blue">{sec.sectionCode}</span>
                      </td>
                      <td style={{ fontSize: 13, color: 'var(--color-text-secondary)' }}>{sec.academicYear}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
