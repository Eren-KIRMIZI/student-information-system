...
export const updateStudentStatus = (id, isActive) =>
  axiosInstance.put(`/students/${id}/status`, { isActive }).then((r) => r.data);
...
export const updateLecturerStatus = (id, isActive) =>
  axiosInstance.put(`/lecturers/${id}/status`, { isActive }).then((r) => r.data);
