...
// ====== Attendance ======
export const getSectionAttendance = (id, params) => axiosInstance.get(`/course-sections/${id}/attendance`, { params }).then(r => r.data);
export const createAttendance     = (id, data)   => axiosInstance.post(`/course-sections/${id}/attendance`, data).then(r => r.data);
