...
// ====== Weekly Schedule ======
export const getSectionWeeklySchedule = (id) =>
  axiosInstance.get(`/course-sections/${id}/weekly-schedule`).then((r) => r.data.data);
export const getMyWeeklySchedule = () => axiosInstance.get('/weekly-schedule/me').then((r) => r.data.data);
export const createWeeklySlot = (id, d) =>
  axiosInstance.post(`/course-sections/${id}/weekly-schedule`, d).then((r) => r.data);
...
// ====== Exam Schedule ======
export const getSectionExamSchedule = (id, params) =>
  axiosInstance.get(`/course-sections/${id}/exam-schedule`, { params }).then((r) => r.data.data);
export const getMyExamSchedule = (params) =>
  axiosInstance.get('/exam-schedule/me', { params }).then((r) => r.data.data);
export const createExamSlot = (id, d) =>
  axiosInstance.post(`/course-sections/${id}/exam-schedule`, d).then((r) => r.data);
...
// ====== Advisor Assignments ======
export const getAdvisorAssignments = (params) =>
  axiosInstance.get('/advisor-assignments', { params }).then((r) => r.data);
export const getAdviseesByLecturer = (id) =>
  axiosInstance.get(`/advisor-assignments/lecturer/${id}/students`).then((r) => r.data.data);
export const createAdvisorAssignment = (data) => axiosInstance.post('/advisor-assignments', data).then((r) => r.data);
export const deactivateAdvisorAssignment = (id) =>
  axiosInstance.put(`/advisor-assignments/${id}/deactivate`).then((r) => r.data);
...
export const uploadPhoto = (form) =>
  axiosInstance
    .put('/users/me/photo', form, { headers: { 'Content-Type': 'multipart/form-data' } })
    .then((r) => r.data);
...
export const updateUserStatus = (id, isActive) =>
  axiosInstance.put(`/users/${id}/status`, { isActive }).then((r) => r.data);
...
export const uploadFile = (form) =>
  axiosInstance.post('/uploads', form, { headers: { 'Content-Type': 'multipart/form-data' } }).then((r) => r.data);
export const getSectionMaterials = (id) =>
  axiosInstance.get(`/course-sections/${id}/materials`).then((r) => r.data.data);
