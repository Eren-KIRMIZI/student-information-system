    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#fff', padding: 20, borderRadius: 28, marginBottom: 16, boxShadow: '0 16px 40px rgba(0,0,0,0.2)' }}>
            <img src="/Uni-Photoroom.png" alt="Eren Teknik" style={{ width: 160, height: 160, objectFit: 'contain' }} />
          </div>
          <h1 style={{ color: '#fff', fontSize: 24, fontWeight: 800, margin: 0, textShadow: '0 2px 4px rgba(0,0,0,0.2)' }}>
